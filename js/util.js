...
function xfrm(el, xlatX = 0, xlatY = 0, _scale = 1, rot = 0) {
    const transformString = 'translate3d(' + xlatX + 'px, ' + xlatY + 'px, 0px) ' + 'scale3d(' + _scale + ', ' + _scale + ', 1) ' + 'rotate(' + rot + 'deg)';
...
const downEvt = window.ontouchstart !== undefined ? 'touchstart' : 'mousedown';
const upEvt = window.ontouchend !== undefined ? 'touchend' : 'mouseup';