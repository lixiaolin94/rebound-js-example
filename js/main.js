const example = function () {
  ...
  const exampleObject = document.getElementById('obj');
  spring.addListener({
    onSpringUpdate(_spring) {
      scale( exampleObject, mapValueFromRangeToRange(_spring.getCurrentValue(), 0, -1, 1, 0.5), );
    },
  });
  ...
  exampleObject.addEventListener(downEvt, () => {
